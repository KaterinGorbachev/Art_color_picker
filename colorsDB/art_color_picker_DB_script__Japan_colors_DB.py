...
'''
query = 'CREATE TABLE colors( rgb INTEGER UNSIGNED PRIMARY KEY NOT NULL, name VARCHAR(100) NOT NULL, cmyk TEXT, category VARCHAR(100))'
...
try:
    ...
    colors = [(0xFFB3F0, 'Hermosa Pink', "{'C':0, 'M':30, 'Y':6, 'K':0}", 'red-violet'),
